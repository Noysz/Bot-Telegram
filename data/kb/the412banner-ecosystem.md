...
5. User Mali pake BannerHub/Bannerlator → DXVK pick TIER-aware sama dengan rules existing (Sarek 1.10.3/1.11.1/1.12 vs vanilla 2.x). The412Banner Nightlies punya semua versi via `.wcp`.
